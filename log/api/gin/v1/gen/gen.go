...
import (
	...
	externalRef0 "github.com/ooqls/getset/log/api/v1/gen"
)
...
type ServerInterface interface {
	...
	UpdateLoggingFormat(c *gin.Context, format externalRef0.FormatEnum)
	// Update the logging level
	// (PUT /v1/logging/level/{level})
	UpdateLoggingLevel(c *gin.Context, level externalRef0.LevelEnum)
}
