module github.com/ooqls/getset
...
require (
	...
	github.com/eko/gocache/store/valkey/v4 v4.0.0-20251210114255-199a1cf8811d // indirect
	...
	github.com/valkey-io/valkey-go/valkeycompat v1.0.59 // indirect
